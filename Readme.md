...
Berikut ini adalah link video aplikasi yang dijalankan pada device, cek videonya [di sini](https://youtu.be/9nisGz6PTEg?si=UcivgiOTavB38Y7v)
...
<resources>
    ...
    <color name="color1">#6EFFEB</color>
    <color name="color2">#6A6CFF</color>
    <color name="color3">#CCFF16</color>
...
<resources>
    ...
    <string name="nama">Rizal Zifan Prasetya</string>
    <string name="nim">312310792</string>
</resources>
```
